...
function Backstory(){
    return (
        <div class="story">
            ...
            <h2>The Menu</h2>
            <h3>One important reason we ask about plans is so we can come up with a menu for the weekend. We don't mind cooking dinners and maybe grabbing some sandwich fixins for everyone, but a headcount would be very important. We plan to make a big trip to a local grocery store on our way in. Please feel free to grab any snacks or drinks for yourself that you would want. Reach out if you have any dietary concerns we should know about. Richie sould be able to procure a pony keg from 10 Barrel. The cabin has a full kitchen and a grill. If by chance someone has a menu request or wants to cook a meal, please let us know! Otherwise, we are winging it!</h3>
            ...
            <h2>Photographs</h2>
            <h3>The priority within our budget was the photographer. This day is about making memories, and the photos are the living reminders. The ceremony day might feel slightly different than a normal wedding as we work with our photographer to capture our story. He will be more involved and part of the party. He has a method that we trust, and we can give you more info that weekend so you know what to expect. I would also like to note that our contract with the photographer prohibits personal photos during the ceremony. Someone using a cellphone camera is not a very appealing look in a photo, and we are paying him to make sure our photos are beautiful. There will be lots of opportunites for selfies, and everyone will have access to the photo gallery when it's ready. </h3>
            <br/><br/>
            Built and Designed by Tabatha Delane ©2021 
